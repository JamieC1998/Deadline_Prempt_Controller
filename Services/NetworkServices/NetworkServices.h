...
namespace services {
    ...
    findLinkSlot(std::chrono::time_point<std::chrono::system_clock> baseStart, float bW, float commLatency, float dataSize, std::shared_ptr<std::vector<std::shared_ptr<model::LinkAct>>> netLink);
