...
namespace enums {
	enum class request_type : int {
		...
		halt_req = HALT_REQ,
		state_update = REQ_TYPE_STATE_UPDATE,
		bandwidth_update = BANDWIDTH_UPDATE_ITEM,
		network_disc = NETWORK_DISC_UPDATE,
		regenerate_structure = REGENERATE_DATA_STRUCTURE
	};
}
